...
<div class="container-fluid py-4">
  @if($users->count() != 0) {{-- IF employee EXIST condition -------------------------------------------}}
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a href="{{ url('/hr-manager/view/training-coaching/'.$users->id) }}" class="dropdown-item text-dark fw-bold">Training & Coaching</a>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-md-12">      
          <div class="card">
            <div class="card-body">
            <p class="text-center">There's No Employee Has Been Added. Please Contact Your Moderator For This System</p>
            </div>
          </div>
        </div>
      </div>
