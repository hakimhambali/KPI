...
<div>
  ...
  <body>
                ...
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      {{-- KPI percentage for EACH FUNCTION --}}
                      <div class="card-body bg-gray-300 border-radius-lg mt-2">
                        <div class="row">
                      ...
                      {{-- END KPI percentage for EACH FUNCTION --}}
                    </div>
                  </div>
    ...
    @endpush
  <!-- Master Pencapaian JS Calculation -->
