                    ...
                    <table class="text-center text-sm" style="width: 100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <input type="text"  pattern="[1-4]+" maxlength="1"  class="form-control" id="skor_penyelia" name="skor_penyelia" onkeyup="masterClac();" value="{{ $nilai->skor_penyelia }}" min="0" placeholder="Enter score from 1 to 4 only" required>
