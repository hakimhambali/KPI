            ...
            <div class="col-lg-12">
              ...
              <div class="row">
                <div class="col-md-12 mb-lg-0 mb-4">
                  ...
                  <div class="card">
                    <form action="{{ url('/hr/create/coaching') }}" method="post" enctype="multipart/form-data">
                    @csrf  
                      <div class="card-body">
                        <h6>COACHING FORM</h6><hr>
                      ...
                      <div class="col-md-12 mb-3 mt-2">
                          ...
                          @foreach ($user as $users)
                              <option class="text-uppercase" value="{{$users->id}}">{{$users->name}}</option>
                          @endforeach 
                          </select>
                      </div>
                      ...
                      <div class="col-md-12 mb-3 mt-2">
                          ...
                          <input class="form-control" type="text" name="title" value="{{ old('title') }}" placeholder="Offline Programme Coaching" required>
                      </div>
                      ...
                      <div class="col-md-6 pr-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" pattern="^\d*(\.\d{0,2})?$\-^\d*(\.\d{0,2})?$" maxlength="6" id="hours" name="hours" required >
