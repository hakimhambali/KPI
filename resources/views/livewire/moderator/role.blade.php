              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                  <div class="col-md-12 mb-lg-0 mb-4">
                    ...
                    <div class="card">
                      <form action="{{ url('/moderator/create/role') }}" method="post" enctype="multipart/form-data">
                      @csrf  
                        <div class="card-body">
                          <h6>ROLE FORM</h6><hr>
                          ...
                          <tbody>
                            ...
                            @foreach ($role as $key => $roles)
                              <tr>
                                ...
                                <td class="text-xs fw-bold">{{ $roles->name }}</td>
                                <td class="text-xs fw-bold text-center">{{ $roles->status }}</td>
                                <td class="text-center mx-auto">
                                  <button type="button" datax="{{$roles->id}}" class="btn btn-danger btn-sm btn-icon data-delete" data-bs-toggle="tooltip" data-bs-original-title="Delete"><i class="bi bi-trash3-fill"></i></button>
                                </td>
                              </tr>
                              @endforeach
                            </tbody>
