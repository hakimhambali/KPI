    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->role != "moderator")
                        ...
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() == 'organizational-chart' ? 'active' : '' }}" href="{{ route('organizational-chart') }}">
                                    ...
                                    <span class="sidenav-normal"> Org Chart </span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                {{-- TRAINING & COACHING ----------------------------------------------------------------------------------------------------------------}}
                <li class="nav-item dropdown">
                    <a data-bs-toggle="collapse" href="#training" class="nav-link collapsed dropdown-toggle {{ Route::currentRouteName() == 'view-hours' ? 'active' : '' || Route::currentRouteName() == 'training' ? 'active' : '' || Route::currentRouteName() == 'training_edit' ? 'active' : '' || Route::currentRouteName() == 'coaching' ? 'active' : '' || Route::currentRouteName() == 'coaching_edit' ? 'active' : '' }}" aria-controls="info" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
