<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-sm my-4 fixed-left ms-3"
    id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->role != "moderator")
                <li class="nav-item ">
                    <a data-bs-toggle="collapse" href="#profile" class="nav-link collapsed" aria-controls="profile" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="collapse" id="profile" style="">
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() == 'view-profile' ? 'active' : '' }}" href="{{ route('view-profile') }}">
                                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() == 'edit-profile' ? 'active' : '' }}" href="{{ route('edit-profile') }}">
                                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() == 'policy' ? 'active' : '' }}" href="{{ route('policy') }}">
                                    ...
                                    <span class="sidenav-normal"> Policies </span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            @if (Auth::user()->role != "moderator")
                <li class="nav-item ">
                    ...
                    <div class="collapse" id="about" style="">
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() == 'core-value' ? 'active' : '' }}" href="{{ route('core-value') }}">
                                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                ...
                                <span class="nav-link-text ms-1">Core Values</span>
                                    </a>
                                </li>
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() == 'organizational-chart' ? 'active' : '' }}" href="{{ route('organizational-chart') }}">
                                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                    ...
                                    <span class="sidenav-normal"> Our Chart </span>
                                </a>
                            </li>
                        </ul>
                    </div>
