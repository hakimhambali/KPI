...
class KPI extends Component
{
    ...
    public function kpi_master_edit1($id, $date_id, $user_id, $year, $month) {
        $kadskormastercount = KPIMaster_::where('fungsi', '=', 'Kad Skor Korporat')->Where('user_id', '=', auth()->user()->id)->where('year', '=', $year)->where('month', '=', $month)->orderBy('created_at','asc')->count();
    ...
    public function kpi_master_edit3($id, $date_id, $user_id, $year, $month) {
        $pelangganImastercount = KPIMaster_::where('fungsi', '=', 'Pelanggan (Internal)')->Where('user_id', '=', auth()->user()->id)->where('year', '=', $year)->where('month', '=', $month)->orderBy('created_at','asc')->count();
    ...
    public function kpi_master_edit4($id, $date_id, $user_id, $year, $month) {
        $pelangganIImastercount = KPIMaster_::where('fungsi', '=', 'Pelanggan (External)')->Where('user_id', '=', auth()->user()->id)->where('year', '=', $year)->where('month', '=', $month)->orderBy('created_at','asc')->count();
